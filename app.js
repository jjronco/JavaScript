...
class Votacion {
    ...
    guardarNombreVotacion() {
        ...
        if (!this.nombreVotacion) {
            mensajeError.textContent = "Por favor, ingrese un nombre para la votación o número de Orden del Día.";
            mensajeError.style.display = "block"; // Muestra el mensaje de error
            return false;
        }
        mensajeError.style.display = "none"; // Oculta el mensaje si el nombre es válido
        return true;
    }
