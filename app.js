// Se toman los datos de diputados.json para visualizar los integrantes de cada bloque
async function obtenerDatosDiputados() {
    try {
        const respuesta = await fetch('diputados.json');
        if (!respuesta.ok) {
...
// Inicializa el proceso al cargar el DOM
